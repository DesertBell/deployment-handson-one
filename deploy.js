...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    '/home/ubuntu/ deployment-handson-one-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf deployment-handson-one-temp && mkdir deployment-handson-one-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r deployment-handson-one-temp/* deployment-handson-one/ && rm -rf deployment-handson-one-temp', {
      cwd: '/home/ubuntu'
  });
}
